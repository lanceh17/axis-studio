...
class MusicAPI {
  ...
  /**
   * Build a concise sonic descriptor string for MiniMax Music API.
   * When a producer is selected, their promptSuffix IS the full descriptor
   * (already contains genre, instruments, vibe). We layer mood/BPM on top.
   * Max length: 2000 chars (API limit for music-3.0 instrumental).
   */
  buildPrompt({ genre = 'Trap', bpm, mood = 'Dark', style = '', reference = '', extraPrompt = '' }, producer = null) {
    const parts = [];

    if (producer && producer.promptSuffix) {
      parts.push(producer.promptSuffix);
    } else {
      parts.push(`${genre.toLowerCase()} instrumental beat`);
      if (style) parts.push(style);
      if (reference) parts.push(`${reference} style`);
    }

    parts.push(this._moodAdj(mood));
  ...
  _moodAdj(mood) {
    const map = {
      ...
      'Aggressive': 'aggressive raw intense',
  ...
  async testConnection() {
    ...
    try {
      const probePrompt = 'short instrumental test beat, minimal';
      const probeBody = {
        model: this.model,
        prompt: probePrompt,
        is_instrumental: true,
...
const PRODUCERS = [
  ...
  { id: 'metro-boomin', name: 'Metro Boomin', genres: ['Trap', 'Drill', 'R&B'], bpmRange: '130-160', signatureSound: 'Sinister melodies, cinematic strings, heavy 808s, sparse hi-hats', keywords: 'dark cinematic, sliding 808s, eerie melody, sparse hats, heavy bass', promptSuffix: 'modern trap, dark cinematic pads, gliding 808 bass, crisp snare rolls, half-time hats, atmospheric and moody' },
  { id: 'dr-dre', name: 'Dr. Dre', genres: ['Boom Bap', 'G-Funk', 'West Coast'], bpmRange: '85-100', signatureSound: 'Funky basslines, live instrumentation, layered synths, crisp snares', keywords: 'west coast g-funk, funky bass, live instrumentation, crisp snare, layered synths', promptSuffix: 'West Coast G-funk, funky synth leads, deep 808 bass, slow bounce groove, talkbox flourishes, smoked-out sunset vibe' },
  { id: 'j-dilla', name: 'J Dilla', genres: ['Boom Bap', 'Lo-Fi', 'Hip Hop'], bpmRange: '80-95', signatureSound: 'Off-kilter drums, soul samples, swung grooves, warm vinyl texture', keywords: 'off-kilter drums, soulful samples, swung groove, lo-fi warmth, dusty vinyl', promptSuffix: '90s boom bap, dusty vinyl-sampled drums, jazz piano loops, warm bass, raw MPC swing, underground soul' },
  { id: 'pharrell', name: 'Pharrell Williams', genres: ['Pop', 'R&B', 'Funk', 'Hip Hop'], bpmRange: '95-130', signatureSound: 'Bouncy rhythms, bright synths, sparse arrangements, 4/4 simplicity', keywords: 'bouncy rhythm, bright synths, sparse arrangement, pop hook, funky groove', promptSuffix: 'bouncy pop-funk, bright synth stabs, minimal arrangement, crisp drums, catchy rhythmic groove' },
  { id: 'timbaland', name: 'Timbaland', genres: ['R&B', 'Pop', 'Hip Hop', 'World'], bpmRange: '70-120', signatureSound: 'Polyrhythmic drums, unique percussion, staccato strings, spacey soundscapes', keywords: 'polyrhythmic drums, unique percussion, staccato strings, spacey, futuristic', promptSuffix: 'quirky pop-R&B, unconventional percussion, stuttering vocal chops, layered world-influenced drums, syncopated glitchy groove' },
  { id: 'mike-dean', name: 'Mike Dean', genres: ['Trap', 'Hip Hop', 'Experimental'], bpmRange: '120-160', signatureSound: 'Massive synth soundscapes, distorted 808s, psychedelic elements, analog warmth', keywords: 'massive synths, distorted 808s, psychedelic, analog, atmospheric', promptSuffix: 'massive analog synth soundscapes, distorted 808 bass, psychedelic textures, reverb-heavy, wide stereo' },
  { id: 'madlib', name: 'Madlib', genres: ['Boom Bap', 'Lo-Fi', 'Jazz Rap', 'Experimental'], bpmRange: '75-100', signatureSound: 'Abstract samples, raw drums, jazz influences, lo-fi aesthetic, unpredictable', keywords: 'abstract samples, raw drums, jazz influence, lo-fi, unpredictable, dusty', promptSuffix: 'abstract sample-based beat, raw drums, lo-fi jazz aesthetic, unpredictable chops, dusty vinyl texture' },
  { id: 'alchemist', name: 'The Alchemist', genres: ['Boom Bap', 'Hip Hop', 'Lo-Fi'], bpmRange: '80-100', signatureSound: 'Gritty samples, loop-based, vinyl crackle, classic drum machines, smoky atmosphere', keywords: 'gritty samples, loop-based, vinyl crackle, SP-1200, smoky atmosphere', promptSuffix: 'gritty loop-based beat, vinyl crackle, SP-1200 drums, warm bass, smoky atmosphere' },
  { id: 'mustard', name: 'DJ Mustard', genres: ['Ratchet', 'West Coast', 'Pop'], bpmRange: '95-110', signatureSound: 'Minimalist claps, simple 808 patterns, catchy whistles, speaker-rattling bass', keywords: 'minimalist claps, simple 808 pattern, catchy whistle, speaker-rattling bass', promptSuffix: 'minimalist west coast ratchet, simple 808 pattern, catchy synth stabs, heavy clap, speaker-rattling bass' },
  { id: 'murda-beatz', name: 'Murda Beatz', genres: ['Trap', 'Drill', 'Pop'], bpmRange: '130-155', signatureSound: 'Hard trap drums, sliding 808s, simple melodies, dancefloor energy', keywords: 'hard trap drums, sliding 808s, simple melody, dancefloor, energetic', promptSuffix: 'hard trap, sliding 808 bass, punchy drums, simple catchy melody, dancefloor energy' },
  { id: 'kanye', name: 'Kanye West', genres: ['Hip Hop', 'Experimental', 'Soul', 'Gospel'], bpmRange: '60-140', signatureSound: 'Soul chops, pitched-up vocals, orchestral elements, genre-defying arrangements', keywords: 'soul chops, pitched vocals, orchestral, experimental, genre-defying, stadium', promptSuffix: 'soulful orchestral hip hop, pitched-up soul samples, stadium drums, genre-blending production, cinematic builds' },
  { id: 'hit-boy', name: 'Hit-Boy', genres: ['Trap', 'Boom Bap', 'R&B', 'West Coast'], bpmRange: '90-150', signatureSound: 'Crisp production, heavy bass, layered melodies, versatile across styles', keywords: 'crisp production, heavy bass, layered melodies, versatile, polished', promptSuffix: 'polished trap-infused beat, crisp drums, layered melodic elements, heavy bass, clean modern mix' },
  { id: 'boi-1da', name: 'Boi-1da', genres: ['Hip Hop', 'R&B', 'Pop', 'Drill'], bpmRange: '80-150', signatureSound: 'Hard drums, dark melodies, minimalist approach, heavy sub-bass', keywords: 'hard drums, dark melodies, minimalist, sub-bass, atmospheric', promptSuffix: 'hard-hitting hip hop, dark minimalist melodies, heavy sub-bass, crisp drums, atmospheric texture' },
  { id: 'zaytoven', name: 'Zaytoven', genres: ['Trap', 'R&B', 'Gospel'], bpmRange: '130-170', signatureSound: 'Fast melodic runs on keys, trap drums, gospel-influenced chord progressions', keywords: 'fast melodic keys, trap drums, gospel influence, bright melodies, piano', promptSuffix: 'trap with fast gospel-influenced keyboard melodies, bright piano runs, rolling 808s, trap hi-hats' },
  { id: 'kenny-beats', name: 'Kenny Beats', genres: ['Trap', 'Boom Bap', 'Pop', 'Jersey Club'], bpmRange: '90-150', signatureSound: '808 slides, punchy kicks, clean mix, modern lo-fi, creative samples', keywords: '808 slides, punchy kicks, clean mix, modern lo-fi, creative samples', promptSuffix: 'modern trap, 808 slides, punchy kicks, clean production, creative samples, lo-fi textures' },
  { id: 'dj-premier', name: 'DJ Premier', genres: ['Boom Bap', 'East Coast', 'Hip Hop'], bpmRange: '85-100', signatureSound: 'Chopped samples, hard snares, scratching, raw drums, gritty basslines', keywords: 'chopped samples, hard snares, scratching, raw drums, gritty, boom bap', promptSuffix: '90s boom bap, chopped soul samples, hard snares, scratching, raw gritty drums, New York underground' },
  { id: 'rza', name: 'RZA', genres: ['Boom Bap', 'East Coast', 'Hip Hop'], bpmRange: '80-105', signatureSound: 'Raw dusty drums, kung fu samples, eerie strings, lo-fi grit, Wu-Tang darkness', keywords: 'raw dusty drums, kung fu samples, eerie strings, lo-fi grit, wu-tang darkness', promptSuffix: 'raw lo-fi east coast beat, dusty drums, eerie string samples, gritty texture, dark Wu-Tang atmosphere' },
  { id: 'just-blaze', name: 'Just Blaze', genres: ['Boom Bap', 'Hip Hop', 'Soul'], bpmRange: '80-105', signatureSound: 'Soaring soul samples, stadium drums, orchestral energy, dramatic builds', keywords: 'soaring soul samples, stadium drums, orchestral, dramatic builds, anthemic', promptSuffix: 'anthemic soulful hip hop, soaring soul samples, stadium-energy drums, orchestral builds, dramatic drops' },
  { id: 'no-id', name: 'No I.D.', genres: ['Boom Bap', 'Hip Hop', 'R&B', 'Soul'], bpmRange: '75-100', signatureSound: 'Soulful samples, warm textures, smooth drums, Chicago sound, introspective', keywords: 'soulful samples, warm textures, smooth drums, chicago sound, introspective', promptSuffix: 'warm soulful hip hop, smooth drums, sample-based texture, introspective Chicago feel, warm bass' },
  { id: '9th-wonder', name: '9th Wonder', genres: ['Boom Bap', 'Hip Hop', 'Soul', 'Lo-Fi'], bpmRange: '85-100', signatureSound: 'Soulful chopped samples, warm bass, crisp drums, melodic loops, boom bap revival', keywords: 'soulful chopped samples, warm bass, crisp drums, melodic loops, boom bap', promptSuffix: 'soulful boom bap, warm chopped samples, crisp melodic drums, smooth bass, nostalgic groove' },
  { id: 'swizz-beatz', name: 'Swizz Beatz', genres: ['Hip Hop', 'Pop', 'Dance'], bpmRange: '90-120', signatureSound: 'Bouncy synth stabs, heavy kicks, energetic drums, call-and-response hooks', keywords: 'bouncy synth stabs, heavy kicks, energetic drums, call-and-response, dance', promptSuffix: 'high-energy hip hop, bouncy synth stabs, heavy kicks, energetic drums, party atmosphere' },
  { id: 'lex-luger', name: 'Lex Luger', genres: ['Trap', 'Hip Hop', 'Southern'], bpmRange: '130-160', signatureSound: 'Rolling 808s, aggressive hi-hat rolls, dark synths, minimalist trap', keywords: 'rolling 808s, aggressive hi-hat rolls, dark synths, minimalist trap, southern', promptSuffix: 'aggressive trap, rolling 808s, dark synths, rapid hi-hat rolls, minimalist southern energy' },
  { id: 'pierre-bourne', name: 'Pierre Bourne', genres: ['Trap', 'Rage', 'Hip Hop', 'Experimental'], bpmRange: '130-170', signatureSound: 'Bouncy 808s, psychedelic melodies, glitchy percussion, catchy loops, rage energy', keywords: 'bouncy 808s, psychedelic melodies, glitchy percussion, catchy loops, rage', promptSuffix: 'psychedelic rage trap, bouncy 808s, glitchy catchy melodies, bright synths, high energy' },
  { id: 'havoc', name: 'Havoc (Mobb Deep)', genres: ['Boom Bap', 'East Coast', 'Hip Hop'], bpmRange: '80-100', signatureSound: 'Dark piano loops, gritty drums, ominous atmosphere, raw street sound', keywords: 'dark piano loops, gritty drums, ominous atmosphere, raw, street, east coast', promptSuffix: 'dark east coast boom bap, gritty drums, ominous piano loops, raw street atmosphere, lo-fi grit' },
  { id: 'pete-rock', name: 'Pete Rock', genres: ['Boom Bap', 'Jazz Rap', 'Hip Hop'], bpmRange: '85-100', signatureSound: 'Smooth jazz samples, crisp drums, melodic basslines, laid-back groove, soulful', keywords: 'smooth jazz samples, crisp drums, melodic basslines, laid-back groove, soulful', promptSuffix: 'smooth jazz-infused boom bap, crisp drums, melodic basslines, soulful laid-back groove, warm samples' },
  { id: 'mannie-fresh', name: 'Mannie Fresh', genres: ['Bounce', 'Southern', 'Hip Hop'], bpmRange: '85-110', signatureSound: 'Bouncy synth bass, heavy kick drums, call-and-response chants, new orleans bounce', keywords: 'bouncy synth bass, heavy kick drums, call-and-response, new orleans bounce, party', promptSuffix: 'New Orleans bounce, bouncy synth bass, heavy kick drums, party energy, call-and-response rhythm' },
  { id: 'dj-khalil', name: 'DJ Khalil', genres: ['Boom Bap', 'West Coast', 'Hip Hop', 'R&B'], bpmRange: '80-100', signatureSound: 'Cinematic strings, soulful samples, west coast bounce, live instrumentation', keywords: 'cinematic strings, soulful samples, west coast bounce, live instrumentation', promptSuffix: 'cinematic west coast hip hop, soulful samples, live instrumentation, warm bass, atmospheric strings' },
  { id: 'trent-reznor', name: 'Trent Reznor / Atticus Ross', genres: ['Industrial', 'Ambient', 'Electronic', 'Film Score'], bpmRange: '60-130', signatureSound: 'Dark industrial textures, glitchy electronics, ambient soundscapes, distorted bass', keywords: 'dark industrial, glitchy electronics, ambient, distorted, cinematic, textured', promptSuffix: 'dark industrial electronic, glitchy textures, ambient soundscapes, distorted bass, cinematic atmosphere' },
  { id: 'southside', name: 'Southside (808 Mafia)', genres: ['Trap', 'Hip Hop', 'Southern'], bpmRange: '130-170', signatureSound: 'Heavy 808s, dark melodies, aggressive hi-hat rolls, minimalist trap, Atlanta bounce', keywords: 'heavy 808s, dark melodies, aggressive hi-hats, minimalist trap, atlanta, 808 mafia', promptSuffix: 'hard Atlanta trap, heavy 808 bass, dark melodies, aggressive hi-hat rolls, minimalist energy' },
  { id: 'tay-keith', name: 'Tay Keith', genres: ['Trap', 'Hip Hop', 'Memphis'], bpmRange: '130-160', signatureSound: 'Punchy 808s, dark piano loops, hard-hitting snares, Memphis bounce, minimalist', keywords: 'punchy 808s, dark piano, hard snares, memphis bounce, minimalist, aggressive', promptSuffix: 'hard Memphis trap, punchy 808s, dark piano loops, aggressive snares, minimalist bounce' },
  { id: 'wheezy', name: 'Wheezy Outta Here', genres: ['Trap', 'Hip Hop', 'Southern'], bpmRange: '125-160', signatureSound: 'Melodic trap, sliding 808s, airy pads, catchy loops, polished production', keywords: 'melodic trap, sliding 808s, airy pads, catchy loops, polished, southern', promptSuffix: 'melodic trap, sliding 808 bass, airy pads, catchy loops, polished modern production' },
  { id: 'young-chop', name: 'Young Chop', genres: ['Trap', 'Hip Hop', 'Chicago'], bpmRange: '130-160', signatureSound: 'Dark piano chords, booming 808s, Chicago drill influence, minimal arrangements', keywords: 'dark piano, booming 808s, chicago drill, minimal, eerie, ominous', promptSuffix: 'dark Chicago trap, booming 808s, eerie piano chords, minimal arrangements, ominous atmosphere' },
  { id: 'cardo', name: 'Cardo', genres: ['Trap', 'Hip Hop', 'West Coast'], bpmRange: '100-140', signatureSound: 'Bouncy melodies, crisp drums, laid-back groove, melodic 808s, west coast flavor', keywords: 'bouncy melodies, crisp drums, laid-back groove, melodic 808s, west coast', promptSuffix: 'bouncy melodic trap, crisp drums, laid-back groove, smooth 808s, west coast flavor' },
  { id: 'fki-1st', name: 'FKi 1st', genres: ['Trap', 'Hip Hop', 'Experimental'], bpmRange: '100-150', signatureSound: 'Eclectic samples, quirky melodies, heavy bass, experimental drum patterns, genre-blending', keywords: 'eclectic samples, quirky melodies, heavy bass, experimental drums, genre-blending', promptSuffix: 'eclectic experimental trap, quirky melodies, heavy bass, genre-blending drum patterns' },
  { id: 'hitmaka', name: 'Hitmaka', genres: ['R&B', 'Hip Hop', 'Pop'], bpmRange: '85-120', signatureSound: 'Polished R&B production, smooth melodies, crisp drums, catchy hooks, radio-ready', keywords: 'polished r&b, smooth melodies, crisp drums, catchy hooks, radio-ready, clean', promptSuffix: 'polished R&B-infused hip hop, smooth melodies, crisp drums, radio-ready production' },
  { id: 'drumma-boy', name: 'Drumma Boy', genres: ['Hip Hop', 'Southern', 'Trap'], bpmRange: '70-100', signatureSound: 'Heavy kick drums, deep 808s, Memphis bounce, anthemic hooks, southern swagger', keywords: 'heavy kicks, deep 808s, memphis bounce, anthemic hooks, southern, swagger', promptSuffix: 'heavy southern hip hop, deep 808s, Memphis bounce, anthemic energy, kick-heavy drums' },
  { id: 'lil-c', name: 'Lil C (Tumay)', genres: ['Trap', 'Hip Hop', 'Southern'], bpmRange: '130-165', signatureSound: 'Aggressive trap drums, dark synths, rattling hi-hats, raw energy, dirty south', keywords: 'aggressive trap, dark synths, rattling hi-hats, raw energy, dirty south', promptSuffix: 'raw aggressive trap, dark synths, rattling hi-hats, dirty south energy, hard-hitting drums' },
  { id: 'dj-squeaky', name: 'DJ Squeaky', genres: ['Hip Hop', 'Memphis', 'Bounce'], bpmRange: '65-95', signatureSound: 'Memphis bounce, deep 808s, dark loops, repetitive hooks, crunk-influenced', keywords: 'memphis bounce, deep 808s, dark loops, repetitive hooks, crunk, lo-fi', promptSuffix: 'dark Memphis bounce, deep 808s, lo-fi loops, crunk-influenced energy, repetitive hooks' },
  { id: 'bangladesh', name: 'Bangladesh', genres: ['Trap', 'Hip Hop', 'Southern'], bpmRange: '130-160', signatureSound: 'Minimalist trap, heavy 808s, catchy synth loops, Atlanta sound, hard-hitting', keywords: 'minimalist trap, heavy 808s, catchy synth loops, atlanta, hard-hitting', promptSuffix: 'minimalist Atlanta trap, heavy 808s, catchy synth loops, hard-hitting drums' },
  { id: 'shawty-redd', name: 'Shawty Redd', genres: ['Trap', 'Hip Hop', 'Southern'], bpmRange: '120-155', signatureSound: 'Dark cinematic trap, orchestral hits, heavy 808s, dramatic builds, Atlanta', keywords: 'dark cinematic trap, orchestral hits, heavy 808s, dramatic builds, atlanta', promptSuffix: 'dark cinematic trap, orchestral hits, heavy 808s, dramatic builds, Atlanta energy' },
  { id: 'lil-jon', name: 'Lil Jon', genres: ['Crunk', 'Hip Hop', 'Southern'], bpmRange: '75-100', signatureSound: 'Crunk energy, heavy bass, call-and-response chants, hype drums, party anthems', keywords: 'crunk, heavy bass, call-and-response, hype drums, party anthems, energetic', promptSuffix: 'high-energy crunk, heavy bass, hype drums, call-and-response rhythm, party anthem energy' },
  { id: 'master-p', name: 'Master P / Beats By The Pound', genres: ['Hip Hop', 'Southern', 'Bounce'], bpmRange: '70-100', signatureSound: 'New orleans bounce, deep bass, synth stabs, laid-back groove, no Limit sound', keywords: 'new orleans bounce, deep bass, synth stabs, laid-back groove, no limit', promptSuffix: 'New Orleans bounce, deep bass, synth stabs, laid-back southern groove' },
  { id: 'kirk-king', name: 'Kirk King', genres: ['West Coast', 'Hip Hop', 'G-Funk'], bpmRange: '85-105', signatureSound: 'G-funk synths, funky basslines, west coast bounce, live instrumentation, laid-back', keywords: 'g-funk synths, funky basslines, west coast bounce, live instrumentation, laid-back', promptSuffix: 'West Coast G-funk, funky basslines, smooth synths, laid-back bounce, live instrumentation' },
  { id: 'hello-kenny', name: 'Hello Kenny', genres: ['West Coast', 'Hip Hop'], bpmRange: '85-105', signatureSound: 'West coast bounce, deep bass, melodic loops, laid-back grooves, California vibe', keywords: 'west coast bounce, deep bass, melodic loops, laid-back, california vibe', promptSuffix: 'West Coast hip hop, deep bass, melodic loops, laid-back California bounce' },
  { id: 'bandplay', name: 'BandPlay', genres: ['West Coast', 'Hip Hop', 'Ratchet'], bpmRange: '90-115', signatureSound: 'West coast ratchet, bouncy drums, catchy stabs, party energy, LA sound', keywords: 'west coast ratchet, bouncy drums, catchy stabs, party energy, la sound', promptSuffix: 'West Coast ratchet, bouncy drums, catchy stabs, LA party energy' },
];
